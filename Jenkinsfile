    ...
    stages {
        ...
        stage("Docker run") {
            steps {
                ...
                sh 'docker run -d --name sbs-community-backend-dev -v /home/ubuntu/.aws:/root/.aws -p 8182:8089 --net my-tube-net --restart unless-stopped sbs-community-backend:latest'
            }
        }
    }
}